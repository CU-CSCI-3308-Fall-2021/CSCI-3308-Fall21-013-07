...
<main>
    <div class="map-page-container">
        <?php 
            if ($mapFound) {
                echo '<h1 class="drawing-title" id="drawingTitle">'.$drawingName.'</h1>';
                echo '<div class="map-container">';
                echo '<div class="img-container">';
                echo '<img id="img" class="map-img" src="drawings/'.$fileNamePrint.'.png" alt="Map drawing by user '.$row['username'].'">';
                echo '<div class="canvas-wrap" style="display: none;">
        ...
        <div class="map-info">
            <?php
                if(isset($dateModified)) {
                    ...
                    echo '<input class="create-btn" type="button" value="Export" id="exp" onclick="exportMap3()">';
